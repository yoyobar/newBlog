...
const SeriesContent = ({ view }: SeriesContentProps) => {
    const sortedView = view.sort((a, b) => a.meta.date.localeCompare(b.meta.date));
    return (
        <div className="flex flex-col gap-2 mb-10">
            {sortedView.map((item, index) => (
                <Link
                ...
                >
                    ...
                    <div className="hidden lg:flex">
                        ...
                        <div className="flex text-2xl gap-2 w-[80px]">
                            ...
                            <div className="text-gray-400">{item.meta.readingMinutes} Min</div>
                        </div>
                    </div>
                </Link>
            ))}
