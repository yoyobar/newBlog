...
image: '/img/2024-05-30-20-53-52.webp'
tags: [next.js, Hydration, next14, trouble-Shooting]
...
사전 렌더링 과정에서 `건조한` html만 제공할경우, javascript로 `물`을 주어 촉촉하게
만들어줄 수 없기 때문에 이러한 부분을 `hydration`이라고 부릅니다.
...
위 데이터는 `hydration Error`가 발생하는 코드입니다.
